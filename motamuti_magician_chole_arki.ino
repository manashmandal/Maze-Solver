/*
  ...
  Currently working on straight or right and intersection
...
int y2 = 0;
int Speed = 150;
int reducedSpeed = Speed  - 50; // AR
int uTurnSpeed = Speed - 65;
...
void uTurn()
{
  ...
  if ((leftReading[0] == '0' && rightReading[0] == '0') && ( pattern[2]=='1' || pattern[3] == '1' || pattern[4] == '1' || pattern[5] == '1' || pattern[6] == '1')){
     if (strcmp(pattern, requiredPos[0]) == 0 || strcmp(pattern, requiredPos[1]) == 0 || strcmp(pattern, requiredPos[2]) == 0 ||  strcmp(pattern, requiredPos[3]) == 0 ) {setMotors(reducedSpeed, reducedSpeed); delay(25);}
     else fixit(); 
  }
  
  else {
   setMotors(-(uTurnSpeed + 5) , uTurnSpeed); // AR
   delay(1); 
  }
}
   ...
   // Added right turn
           ...
           )
           {
             ...
             */
             ...
             if (leftReading[0] == '0' && rightReading[0] == '0'){
                 
               // back kora lagte pare
           ...
           /*  setMotors(-Speed, -Speed);
             ...
             if (strcmp(pattern, "00000000") == 0 || strcmp(rightReading, "1") == 0) {
              ...
              setMotors(reducedSpeed, -(reducedSpeed + 10)); // CMFC
             delay(250);                          // CFMC
